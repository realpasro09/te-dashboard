...
export const GET_SOURSES = 'GET_SOURSES';
export const GET_SOURSES_SUCCESS = 'GET_SOURSES_SUCCESS';
export const CHANGE_SOURCESCHECKBOX_VALUE_SUCCESS = 'CHANGE_SOURCESCHECKBOX_VALUE_SUCCESS';
export const CHANGE_SOURCECHECKBOX_VALUE = 'CHANGE_SOURCECHECKBOX_VALUE';
